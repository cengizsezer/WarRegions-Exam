...
public class LandSoldierVFXView : BaseMobVFXView, IPoolable<IMemoryPool>
{
    ...
    public class Factory : PlaceholderFactory<LandSoldierVFXView>
    {
    }
    public class Pool : MonoPoolableMemoryPool<IMemoryPool, LandSoldierVFXView>
    {
    }
}
