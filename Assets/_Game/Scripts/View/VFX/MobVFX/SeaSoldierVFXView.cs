...
public class SeaSoldierVFXView : BaseMobVFXView, IPoolable<IMemoryPool>
{
    ...
    public class Factory : PlaceholderFactory<SeaSoldierVFXView>
    {
    }
    public class Pool : MonoPoolableMemoryPool<IMemoryPool, SeaSoldierVFXView>
    {
    }
}
