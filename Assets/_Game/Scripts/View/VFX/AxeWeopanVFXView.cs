...
public class AxeWeopanVFXView : BaseWeopanVFXView, IPoolable<IMemoryPool>
{
    ...
    public class Factory : PlaceholderFactory<AxeWeopanVFXView>
    {
    }
    public class Pool : MonoPoolableMemoryPool<IMemoryPool, AxeWeopanVFXView>
    {
    }
}
